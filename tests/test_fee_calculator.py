...
# Test for calculating fee for transactions up to R$1000
...
# Test for calculating fee for transactions between R$1001 and R$5000
...
# Test for calculating fee for transactions above R$5000
